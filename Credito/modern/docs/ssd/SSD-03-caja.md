...
| Asignar (modal Saldos) | `/caja/asignar` | Exact menu |
...
Aceptadas de producto: grilla de desembolsos APR (el MVC era un formulario); modal de movimientos de toda la caja; tickets auto cuando el SP devuelve id; rendiciones de caja chica en línea (no pixel-perfect de modales legacy).
...
- Smoke: abrir diario, cobrar una cuota, arqueo, verificar un pago; encargado en saldos

## 10. Go-live

Listo en Development. Cutover: humo cajero + encargado (asignar, cierre masivo, caja chica) en preprod.
