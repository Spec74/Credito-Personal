...
/** Columnas — mismo orden que PDF <c>rptCreditoObservado.rdlc</c> / catálogo legacy. */
export function buildCreditoObservadoInformeColumns(): ColumnsType<RptCreditoObservadoRow> {
  return [
