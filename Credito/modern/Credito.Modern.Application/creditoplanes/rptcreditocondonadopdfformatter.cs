...
/// <summary>
/// PDF tabular (QuestPDF) con los mismos datos que JSON/CSV; no replica layout <c>rptCreditoCondonado.rdlc</c>.
/// </summary>
public static class RptCreditoCondonadoPdfFormatter
{
    private const string DateTimeFormat = "yyyy-MM-dd HH:mm";

    static RptCreditoCondonadoPdfFormatter()
    {
            ...
            document.Page(page =>
            {
                ...
                page.Content().Table(table =>
                {
                    ...
                    table.Header(header =>
                    {
                        ...
                        header.Cell().Text("Condonado").Bold();
                    ...
                    foreach (var r in rows)
                    {
                        ...
                        table.Cell().Text(r.MontoCondonado.ToString("N2", inv));
