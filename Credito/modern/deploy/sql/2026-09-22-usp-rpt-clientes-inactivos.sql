-- Actualiza CREDITO.usp_RptClientesInactivos con TopeCredito, Depurado,
-- ClasificacionRiesgoSBS y filtro @UsuarioId / @OficinaId (gestor vs TODOS).
...
CREATE OR ALTER PROC [CREDITO].[usp_RptClientesInactivos]
	@UsuarioId INT = NULL,
	@OficinaId INT = NULL,
