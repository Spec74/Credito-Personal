...
public sealed class ReportesCatalogoCoberturaReadService : IReportesCatalogoCoberturaReadService
{
    ...
    [
        ...
        P("cobros-del-dia", "Cobros del día", "caja", "CobrosdelDia",
            "/api/v1/credito/rpt-cobro-diario", "/api/v1/credito/rpt-cobro-diario-csv",
            "/api/v1/credito/rpt-cobro-diario-pdf",
            "Grilla MVC; datos = usp_RptCobroDiario (filtro mora solo en pantalla)."),
        P("listar-cobros-del-dia-json", "Cobros del día (JSON)", "caja", "ListarCobrosDelDiaJson",
            "/api/v1/credito/rpt-cobro-diario", "/api/v1/credito/rpt-cobro-diario-csv",
            "/api/v1/credito/rpt-cobro-diario-pdf",
            "JSON jqGrid MVC; mismo proc que cobros-del-dia / reporte-cobro-diario."),
        P("cobranza-pagos", "Cobranza pagos", "caja", "CobranzaPagos",
            ...
            null,
            "SPA /reportes/cobranza; datos = usp_RptCobroDiarioDetalle."),
        ...
        P("reporte-morosidad-gestor", "Reporte morosidad por gestor", "credito", "ReporteMorosidadGestor",
            "/api/v1/credito/rpt-cobro-diario", "/api/v1/credito/rpt-cobro-diario-csv",
            "/api/v1/credito/rpt-cobro-diario-pdf",
            "SPA /informes/morosidad-gestor filtra mora>0; PDF RDLC layout legacy opcional Fase 4."),
