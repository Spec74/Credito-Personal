...
public sealed class RptSaldosCajaResumenIngresoReadService(IOptions<SqlDatabaseOptions> options)
    : IRptSaldosCajaResumenIngresoReadService
{
    private readonly string _connectionString = options.Value.ConnectionString;

    public async Task<string?> ObtenerPrimerTextoAsync(
        int cajaDiarioId,
        int oficinaId,
        CancellationToken cancellationToken = default)
    {
        ...
        var command = new CommandDefinition(
            ...
            new { CajaDiarioId = cajaDiarioId, OficinaId = oficinaId },
