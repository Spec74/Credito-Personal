...
public sealed class RptClientesNuevosMesReadService(IOptions<SqlDatabaseOptions> options)
    : IRptClientesNuevosMesReadService
{
    private const string Sql = """
        ...
        WHERE c.Estado = 'DES'
          AND cl.FechaRegistro >= @FechaIni
          AND cl.FechaRegistro <= @FechaFinInclusive
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var fechaFinInclusive = fechaFin.Date.AddDays(1);
        ...
        var command = new CommandDefinition(
            ...
            new
            {
                ...
                FechaFinInclusive = fechaFinInclusive,
                OficinaId = oficinaId,
                UsuarioId = usuarioId,
            },
