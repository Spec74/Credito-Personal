        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(
                new Dictionary<string, string?>
                {
                    ...
                    ["CierreGerencial:PermitirAdministradores"] = "false",
                    ["CierreGerencial:UsuarioConsultaIds:0"] = "3",
                    ["CierreGerencial:UsuarioConsultaIds:1"] = "10",
                    ["CierreGerencial:UsuarioMetasIds:0"] = "10",
