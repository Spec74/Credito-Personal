...
namespace ITB.VENDIX.BL
{
    ...
    {
        /// <summary>
        /// Obtiene las tareas del usuario actual con sus subtareas
        /// </summary>
        ...
        public static int GuardarTarea(TareaGuardarViewModel model)
        {
            using (var db = new VENDIXEntities())
            {
                ...
                var todasCompletadas = model.Subtareas != null && 
                                       model.Subtareas.Count > 0 && 
                                       model.Subtareas.All(s => s.Completada);
            ...
            using (var db = new VENDIXEntities())
            {
                ...
                db.SaveChanges();
                    ...
                    public static bool PuedeEditarTarea()
                    {
                        ...
                        using (var db = new VENDIXEntities())
                        {
                            // Verificar si el usuario tiene rol de Administrador o Aprobador
