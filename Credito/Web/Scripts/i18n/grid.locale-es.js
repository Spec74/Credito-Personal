...
$.extend($.jgrid,{
	...
	edit : {
	    ...
	    msg: {
	        ...
	        minValue:"El value debe ser mayor o igual a ",
	        maxValue:"El value debe ser menor o igual a ",
	        email: "no es una dirección de correo válida",
	        integer: "Introduzca un value entero",
			date: "Introduza una fecha correcta ",
			url: "no es una URL válida. Prefijo requerido ('http://' or 'https://')",
			nodefined : " no está definido.",
			novalue : " value de retorno es requerido.",
